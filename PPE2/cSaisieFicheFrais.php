...
$existeFicheFrais = existeFicheFrais($idCnx, $mois, obtenirIdUserConnecte());
  // si elle n'existe pas, on la crée avec les élets frais forfaitisés à 0
if ( !$existeFicheFrais ) {
	ajouterFicheFrais($idCnx, $mois, obtenirIdUserConnecte());
}
...
if ($etape == "validerSaisie") { 
	...
	if (!$ok) {
		ajouterErreur($tabErreurs, "Chaque quantité doit être renseignée et numérique positive.");
      	...
      	modifierEltsForfait($idCnx, $mois, obtenirIdUserConnecte(),$tabQteEltsForfait);
      }
  }                                                       
  elseif ($etape == "validerSuppressionLigneHF") {
  	supprimerLigneHF($idCnx, $idLigneHF);
  }
  elseif ($etape == "validerAjoutLigneHF") {
  	...
  	if ( nbErreurs($tabErreurs) == 0 ) {
  		...
  		ajouterLigneHF($idCnx, $mois, obtenirIdUserConnecte(), $dateHF, $libelleHF, $montantHF);
  	}
  }
  	...
  	<div class="panel panel-default">
  		...
  		<div class="panel-body">
            ...
            // forfaitisés du visiteur connecté pour le mois demandé
  						...
  						$req = obtenirReqEltsForfaitFicheFrais($mois, $idUser);
  						...
  						while (is_array($lgEltForfait)) {
  							...
  							<p>
  								<div class="col-lg-4">
  									...
  									<input class="form-control" type="text" id="<?php echo $idFraisForfait ?>" 
  								...
  								<fieldset>
  									...
  									<p>
  										<div class="col-lg-4">
  											...
  											<input class="form-control" type="text" id="txtDateHF" name="txtDateHF" size="12" maxlength="10" 
  									...
  									<p>
  										<div class="col-lg-4">
  											...
  											<input class="form-control" type="text" id="txtLibelleHF" name="txtLibelleHF" size="70" maxlength="100" 
  									...
  									<p>
  										<div class="col-lg-4">
  											...
  											<input class="form-control" type="text" id="txtMontantHF" name="txtMontantHF" size="12" maxlength="10" 
